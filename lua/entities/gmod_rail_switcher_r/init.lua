...
function ENT:Initialize()
	...
	self:SetModel("models/props_phx/trains/tracks/track_switch.mdl")
	...
	local CLPos = Vector(-75.07,265.37,0.00)
	local CLAng = Angle(0,0,0)
	...
	CurvePiece:SetModel( "models/props_phx/trains/tracks/track_turn45.mdl" ) --vec(-75.07,265.37,0.00)	ang(0,0,0)
	...
	CurvePiece2:SetModel( "models/props_phx/trains/tracks/track_switcher.mdl" )
	CurvePiece2:Spawn()
...
do
	...
	function ENT:Think()
		...
		local tr1 = {}
		tr1.start 			= self:LocalToWorld( CRLPos ) debugoverlay.Box( tr1.start, -Vector(1,1,1) * 100, Vector(1,1,1) * 100, 0.11, Color(255,0,0,25) )
		...
		local tr2 = {}
		tr2.start 			= self:LocalToWorld( SRLPos ) debugoverlay.Box( tr2.start, -Vector(1,1,1) * 100, Vector(1,1,1) * 100, 0.11, Color(255,0,0,25) )
